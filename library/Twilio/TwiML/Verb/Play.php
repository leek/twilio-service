 ...
 * @version    $Id: Play.php 4 2009-04-29 00:45:09Z leeked $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Twilio_TwiML_Verb_Play extends Twilio_TwiML_Verb
{
    ...
    public function setLoop($value)
    {
        ...
        if ($value >= 0) {
            ...
            throw new Twilio_TwiML_Verb_Exception('Invalid `loop` value for Play verb');
        }
